...
function renderCart() {
    ...
    const closeBtn = isMobile ? `<button class="sp-cart-close-btn" onclick="if(window.spCartCloseFunc)window.spCartCloseFunc()" style="width:100%;padding:8px;background:#444;color:#fff;border:none;border-radius:6px;font-size:13px;font-weight:900;cursor:pointer;margin-bottom:8px;">✕ カートを閉じる</button>` : '';
